...
root = './gestures' #'./test' depending upon which the csv is being created

#go through each directory on the root folder given above
...
# go through each file in that directory
    for file in files:
        ...
        value = np.hstack((directory[3:], value))
